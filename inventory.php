...
<head>
  ...
  <title>Inventory - Seri Perangin Catering</title>
  <link rel="stylesheet" href="assets/css/inventory.css?v=2">
</head>
  ...
  <main class="inventory-main">
    ...
    <div class="inventory-card">
      <div class="flex flex-between mb-3">
        <h1 class="inventory-title" style="margin-bottom:0; margin-left:25px">Inventory</h1>
        <button style="margin-right:15px" class="btn btn-accent" id="addItemBtn"><i class="fa-solid fa-plus"></i> Add
          Item</button>
      </div>
      <div class="flex flex-between mb-2">
        <input type="text" style="width:80%; margin-left:25px" id="search" placeholder="Search Inventory">
      </div>
        ...
        <form id="itemForm" method="post" action="inventory.php" enctype="multipart/form-data">
          ...
          <div class="flex flex-between mt-2">
            <button type="submit" class="btn btn-accent" id="saveBtn" name="add_item"><i class="fa-solid fa-save"></i>
              Save</button>
            <button type="button" class="btn btn-danger" id="cancelBtn"><i class="fa-solid fa-xmark"></i>
              Cancel</button>
          </div>
        </form>
      </div>
